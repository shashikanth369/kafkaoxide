...
## Phase 1 — Resizable, responsive 3-pane shell
...
## Phase 2 — Cluster detail panel (middle pane)
...
## Phase 3 — Brokers / Topics / Consumers sub-trees
...
## Phase 5 — Topic detail panel shell + Properties tab
